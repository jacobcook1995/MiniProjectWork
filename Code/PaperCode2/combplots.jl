...
function sixth()
    ...
    # Activate PyPlot
    pyplot(dpi=200,titlefontsize=17,guidefontsize=14,legendfontsize=15,tickfontsize=14) # dpi=300 breaks plotting when using pyplot, hopefully will be resolved
    ...
    plot!(pathBA[:,1],pathBA[:,2],ylabel="Concentration b",color=2,label="",right_margin=50*mm)
