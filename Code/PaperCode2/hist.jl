...
function main()
    ...
    plot!(rangeA,A,label="",grid=false,xlabel=Lx,ylabel=Ly,xticks=false,yticks=false,guidefontsize=25)
    savefig("../Results/wA.png")
    bar(hB,label="",linecolor=:blue,dpi=300,fillalpha=1.0,fillcolor=:blue,xlim=(0,tsB[end]),ylim=(0,1.1*maxB))
    plot!(rangeB,B,label="",grid=false,xlabel=Lx,ylabel=Ly,xticks=false,yticks=false,guidefontsize=25)
