...
function main()
    ...
    for i = 2:N1
        points1[i,3] = sqrt(((points1[i+1,1]-points1[i-1,1])/(2*t1))^2 + ((points1[i+1,2]-points1[i-1,2])/(2*t1))^2)
    end
    points1[N1+1,3] = sqrt(((points1[N1+1,1]-points1[N1,1])/(t1))^2 + ((points1[N1+1,2]-points1[N1,2])/(t1))^2)
    points2[1,3] = sqrt(((points2[2,1]-points2[1,1])/(t2))^2 + ((points2[2,2]-points2[1,2])/(t2))^2)
    for i = 2:N2
        points2[i,3] = sqrt(((points2[i+1,1]-points2[i-1,1])/(2*t2))^2 + ((points2[i+1,2]-points2[i-1,2])/(2*t2))^2)
    end
    points2[N2+1,3] = sqrt(((points2[N2+1,1]-points2[N2,1])/(t2))^2 + ((points2[N2+1,2]-points2[N2,2])/(t2))^2)
